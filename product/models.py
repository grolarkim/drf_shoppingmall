...
class ProductImage(models.Model):
    ...
    full_image = models.ImageField(verbose_name="이미지", upload_to = "product/productimage/")
...
class Product(models.Model):
    ...
    category = models.ManyToManyField(to=Category, verbose_name="카테고리", null=True, blank=True)
    images = models.OneToOneField(to=ProductImage, on_delete=models.CASCADE, blank=True, null=True)
